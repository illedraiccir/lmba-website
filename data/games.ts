...
export const games: Game[] = [
  ...
  },
  {
    ...
    status: "scheduled",
    resultType: "normal",
    headline: "Quarterfinal: No. 1 Ball Starz vs No. 8 Free Agent Team",
    recapTeaser: "The top-seeded Ball Starz open their playoff run against the eighth-seeded Free Agent Team in the Week 8 quarterfinals.",
  },
  {
    ...
    status: "scheduled",
    resultType: "normal",
    headline: "Quarterfinal: No. 2 LMBA Jam vs No. 7 Thrillers",
    recapTeaser: "Second-seeded LMBA Jam begin the postseason against the seventh-seeded Thrillers in a quarterfinal matchup.",
  },
  {
