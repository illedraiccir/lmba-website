...
export const games: Game[] = [
  ...
  },
  {
    ...
    status: "scheduled",
    resultType: "normal",
    headline: "Quarterfinal: No. 4 Department Of Offense vs No. 5 Hash-Slinging Slashers",
    recapTeaser: "Fourth-seeded Department of Offense meet fifth-seeded Hash-Slinging Slashers in a quarterfinal matchup with major semifinal implications.",
  },
  {
    ...
    status: "scheduled",
    resultType: "normal",
    headline: "Quarterfinal: No. 3 Trust The Process vs No. 6 Prestige Worldwide",
    recapTeaser: "Third-seeded Trust The Process open the playoffs against sixth-seeded Prestige Worldwide in the Week 8 quarterfinals.",
  },
];
